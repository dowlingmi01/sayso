	...
	protected function _visitGood (Gaming_BigDoor_Good $good)
	{
		...
		*/
		if (!$good->isToken() && $good->inventory_sold >= $good->inventory_total) {
			...
			$profileSurvey->loadDataByUniqueFields(array("starbar_id" => 4, "reward_category" => "profile"));
			...
			$good->setNonRedeemReason('Earn more Coins by<br />completing polls and surveys!');
			$good->setCommentForUser('Insufficient Coins');
		}
