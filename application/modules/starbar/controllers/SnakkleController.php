...
class Starbar_SnakkleController extends Starbar_ContentController
{
	...
	protected function _assignShareAppToView($facebookCallbackUrl) {
		...
		$fbkAppShareCopy = "I just earned 25 Snakkle Bucks for sharing Snakkle Say.So!
Join Snakkle Say.So and get access big giveaways and awesome prizes.
Say.So is your way of making a lasting impact on the communities you love. Participating in Snakkle Say.So is easy - by giving your opinion, answering polls and taking fun quizzes, you gain points to redeem awesome prizes from Snakkle.";
	...
	protected function _assignShareSurveyToView(Survey $survey, $facebookCallbackUrl) {
		...
		$fbkShareText = 'I just earned 25 Snakkle Bucks for sharing the survey "'. $survey->title .'".
Join Snakkle Say.So and get access big giveaways and awesome prizes.';
	...
	protected function _assignSharePollToView(Survey $survey, $facebookCallbackUrl) {
		$twShareText = "I just answered " . $survey->title ." and earned 25 Snakkle Bucks! Join Snakkle Say.So and earn great prizes!";
		$fbkShareText = 'I just earned 25 Snakkle Bucks for sharing the poll "'. $survey->title .'".
Join Snakkle Say.So and get access big giveaways and awesome prizes.';
