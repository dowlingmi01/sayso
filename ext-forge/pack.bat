...
%LOCALAPPDATA%\Google\Chrome\Application\chrome.exe --pack-extension=%CD%\app\development\chrome --pack-extension-key=%CD%\chromebuild\%filename%.pem --no-message-box
