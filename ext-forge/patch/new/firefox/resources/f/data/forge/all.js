...
(function() {
        ...
        receive: function(p) {
            if (p.callid) {
                ...
                if (p.event) {
                    ...
                    if (h.listeners["*"]) {
                        h.listeners["*"].forEach(function(t) {
                            if (p.params) {
                                t(p.event, p.params)
                            } else {
                                t(p.event)
    ...
    m.notification = {
        ...
        setBadgeNumber: function(q, r, p) {
            h.priv.call("notification.setBadgeNumber", {
                number: q
            }, r, p)
        }
    };
    m.file = {
        getImage: function(q, r, p) {
            ...
            h.priv.call("file.getImage", q, r && function(t) {
                var s = {
                    uri: t,
                    name: "Image",
                    type: "image"
        ...
        getVideo: function(q, r, p) {
            ...
            h.priv.call("file.getVideo", q, r && function(t) {
                var s = {
                    uri: t,
                    name: "Video",
                    type: "video"
        ...
        saveURL: function(q, r, p) {
            h.priv.call("file.saveURL", {
                url: q
            }, r && function(s) {
                r({
                    uri: s
    ...
    m.event = {
        menuPressed: {
            addListener: function(q, p) {
                h.addEventListener("event.menuPressed", q)
            }
        },
        backPressed: {
            addListener: function(q, p) {
                h.addEventListener("event.backPressed", function() {
                    q(function() {
                        h.priv.call("event.backPressed_closeApplication", {})
                    })
                })
            },
            preventDefault: function(q, p) {
                h.priv.call("event.backPressed_preventDefault", {}, q, p)
            },
            restoreDefault: function(q, p) {
                h.priv.call("event.backPressed_restoreDefault", {}, q, p)
            }
        },
        messagePushed: {
            addListener: function(q, p) {
    ...
    m.reload = {
        updateAvailable: function(q, p) {
            h.priv.call("reload.updateAvailable", {}, q, p)
        },
        update: function(q, p) {
            h.priv.call("reload.update", {}, q, p)
        },
        pauseUpdate: function(q, p) {
            h.priv.call("reload.pauseUpdate", {}, q, p)
        },
        applyNow: function(q, p) {
            m.logging.error("reload.applyNow has been disabled, please see docs.trigger.io for more information.");
            p({
                message: "reload.applyNow has been disabled, please see docs.trigger.io for more information.",
                type: "UNAVAILABLE"
            })
        },
        applyAndRestartApp: function(q, p) {
            h.priv.call("reload.applyAndRestartApp", {}, q, p)
        },
        switchStream: function(q, r, p) {
            h.priv.call("reload.switchStream", {
                streamid: q
            }, r, p)
        },
        updateReady: {
            addListener: function(q, p) {
                h.addEventListener("reload.updateReady", q)
            }
        },
        updateProgress: {
            addListener: function(q, p) {
                h.addEventListener("reload.updateProgress", q)
            }
        }
    };
    m.tools = {
	...
	m.firefox = { evaluate: function(c, s, e) { h.priv.call("firefoxeval", c, s, e)} };
    window.forge = m
})();
