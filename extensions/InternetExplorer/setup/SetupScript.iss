...
OutputDir=..
DefaultDirName={pf}\SaySo\
ShowLanguageDialog=no

[Run]
Filename: {reg:HKLM\SOFTWARE\Microsoft\.NETFramework,InstallRoot}\{reg:HKCR\CLSID\{{61b3e12b-3586-3a58-a497-7ed7c4c794b9%7D\InprocServer32\2.0.0.0,RuntimeVersion}\RegAsm.exe; Parameters: /codebase SaySo.dll; WorkingDir: {app}; StatusMsg: Registering controls ...; Flags: runhidden

[UninstallRun]
Filename: {reg:HKLM\SOFTWARE\Microsoft\.NETFramework,InstallRoot}\{reg:HKCR\CLSID\{{61b3e12b-3586-3a58-a497-7ed7c4c794b9%7D\InprocServer32\2.0.0.0,RuntimeVersion}\RegAsm.exe; Parameters: /unregister SaySo.dll; WorkingDir: {app}; StatusMsg: Unregistering controls ...; Flags: runhidden
