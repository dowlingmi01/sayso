SELECT
	...
	t.id AS study_tag_id, t.user_id AS study_tag_user_id, t.name AS study_tag_name, t.type AS study_tag_type, t.tag AS study_tag_tag, t.target_url AS study_tag_target_url, t.created AS study_tag_created, t.modified AS study_tag_modified,
	...
	sc.id AS study_creative_id, sc.user_id AS study_creative_user_id, sc.mime_type_id AS study_creative_mime_type_id, sc.name AS study_creative_name, sc.type AS study_creative_type, sc.ad_title AS study_creative_ad_title, sc.ad_description AS study_creative_ad_description, sc.url AS study_creative_url, sc.target_url AS study_creative_target_url, sc.created AS study_creative_created, sc.modified AS study_creative_modified
FROM
	study s
