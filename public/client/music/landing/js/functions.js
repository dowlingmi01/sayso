	...
	function validateInstall() {
		...
		if( !saysoConf.bn.isSupported ) {
			if( saysoConf.bn.isMobile ) {
				msg = 'Sorry! Music Say.So isn\'t yet available for mobile browsers. Join us via your computer when you can!';
			} else {
				msg = 'Sorry, your web browser doesn\'t support the cool features of Music Say.So. For an optimal experience, use the latest versions of Chrome (www.google.com/chrome), Firefox (www.getfirefox.com) or Safari (www.apple.com/safari). And we support Internet Explorer 8 and above.';
			}
		}
		if( msg ) {
