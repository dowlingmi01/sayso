...
$SQ(function(){
	...
	*/
	...
	starbar.state.update = function (){
		if (starbar.state.profile == 0) starbar.state.profile = Math.round(new Date().getTime() / 1000);
		if (starbar.state.game == 0) starbar.state.game = Math.round(new Date().getTime() / 1000);
		$SQ.ajaxWithAuth({
